void PhotonCounter() {
  ...
  TFile *plume_file = TFile::Open("conf_2_e-_1GeV.root");
  // TFile *plume_file = TFile::Open("conf_2_e-_5GeV.root");
  // TFile *plume_file = TFile::Open("conf_2_e-_10GeV.root");
  // TFile *plume_file = TFile::Open("conf_2_e-_15GeV.root");
  // TFile *plume_file = TFile::Open("conf_2_e-_20GeV.root");
  //
  // TFile *plume_file = TFile::Open("conf_2_p_1GeV.root");
  // TFile *plume_file = TFile::Open("conf_2_p_5GeV.root");
  // TFile *plume_file = TFile::Open("conf_2_p_10GeV.root");
  // TFile *plume_file = TFile::Open("conf_2_p_15GeV.root");
  // TFile *plume_file = TFile::Open("conf_2_p_20GeV.root");
  //
  // TFile *plume_file = TFile::Open("conf_2_pi+_1GeV.root");
  // TFile *plume_file = TFile::Open("conf_2_pi+_5GeV.root");
  // TFile *plume_file = TFile::Open("conf_2_pi+_10GeV.root");
  // TFile *plume_file = TFile::Open("conf_2_pi+_15GeV.root");
  // TFile *plume_file = TFile::Open("conf_2_pi+_20GeV.root");
  ...
  canvas->Print("Configuration_2/Electron/1_GeV/PrimaryCreatedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration_2/Electron/1_GeV/SecondaryCreatedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration_2/Electron/1_GeV/TotalCreatedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration_2/Electron/1_GeV/PrimaryDetectedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration_2/Electron/1_GeV/SecondaryDetectedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration_2/Electron/1_GeV/TotalDetectedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration_2/Electron/1_GeV/ReflectedPhotons.pdf");
  canvas->Clear();

  // hist_inside_photons->SetFillColor(kYellow);
  // hist_inside_photons->Draw();
  // canvas->Print("Configuration_2/Electron/1_GeV/InsidePhotons.pdf");
  // canvas->Clear();
  //
  // hist_outside_photons->SetFillColor(kYellow);
  // hist_outside_photons->Draw();
  // canvas->Print("Configuration_2/Electron/1_GeV/OutsidePhotons.pdf");
  // canvas->Clear();
