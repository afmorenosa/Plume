void PhotonCounter() {
  ...
  canvas->Print("Configuration_3/Electron/1_GeV/PrimaryCreatedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration_3/Electron/1_GeV/SecondaryCreatedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration_3/Electron/1_GeV/TotalCreatedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration_3/Electron/1_GeV/PrimaryDetectedPhotons.pdf");
  canvas->Clear();

  hist_secondary_detected_photons->SetFillColor(kYellow);
  hist_secondary_detected_photons->Draw();
  canvas->Print("Configuration_3/Electron/1_GeV/SecondaryDetectedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration_3/Electron/1_GeV/TotalDetectedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration_3/Electron/1_GeV/ReflectedPhotons.pdf");
  canvas->Clear();

  // hist_inside_photons->SetFillColor(kYellow);
  // hist_inside_photons->Draw();
  // canvas->Print("Configuration_3/Electron/1_GeV/InsidePhotons.pdf");
  // canvas->Clear();
  //
  // hist_outside_photons->SetFillColor(kYellow);
  // hist_outside_photons->Draw();
  // canvas->Print("Configuration_3/Electron/1_GeV/OutsidePhotons.pdf");
  // canvas->Clear();
