void PhotonCounter() {
  ...
  TFile *plume_file = TFile::Open("conf_3_e-_1GeV.root");
  // TFile *plume_file = TFile::Open("conf_3_e-_5GeV.root");
  // TFile *plume_file = TFile::Open("conf_3_e-_10GeV.root");
  // TFile *plume_file = TFile::Open("conf_3_e-_15GeV.root");
  // TFile *plume_file = TFile::Open("conf_3_e-_20GeV.root");
  //
  // TFile *plume_file = TFile::Open("conf_3_p_1GeV.root");
  // TFile *plume_file = TFile::Open("conf_3_p_5GeV.root");
  // TFile *plume_file = TFile::Open("conf_3_p_10GeV.root");
  // TFile *plume_file = TFile::Open("conf_3_p_15GeV.root");
  // TFile *plume_file = TFile::Open("conf_3_p_20GeV.root");
  //
  // TFile *plume_file = TFile::Open("conf_3_pi+_1GeV.root");
  // TFile *plume_file = TFile::Open("conf_3_pi+_5GeV.root");
  // TFile *plume_file = TFile::Open("conf_3_pi+_10GeV.root");
  // TFile *plume_file = TFile::Open("conf_3_pi+_15GeV.root");
  // TFile *plume_file = TFile::Open("conf_3_pi+_20GeV.root");
  ...
  canvas->Print("Configuration 3/Electron/1 GeV/PrimaryCreatedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration 3/Electron/1 GeV/SecondaryCreatedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration 3/Electron/1 GeV/TotalCreatedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration 3/Electron/1 GeV/PrimaryDetectedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration 3/Electron/1 GeV/SecondaryDetectedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration 3/Electron/1 GeV/TotalDetectedPhotons.pdf");
  canvas->Clear();
  ...
  canvas->Print("Configuration 3/Electron/1 GeV/ReflectedPhotons.pdf");
  canvas->Clear();

  // hist_inside_photons->SetFillColor(kYellow);
  // hist_inside_photons->Draw();
  // canvas->Print("Configuration 3/Electron/1 GeV/InsidePhotons.pdf");
  // canvas->Clear();
  //
  // hist_outside_photons->SetFillColor(kYellow);
  // hist_outside_photons->Draw();
  // canvas->Print("Configuration 3/Electron/1 GeV/OutsidePhotons.pdf");
  // canvas->Clear();
